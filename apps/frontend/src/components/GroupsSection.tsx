/**
 * Groups (issue #10) — custom, team-scoped member groups reusable for roster
 * filtering, call-up squad selection (#16), and post targeting (#18).
 *
 * A section of the members page rather than a page of its own: a group is a
 * way of sorting the roster, so it sits in the roster's menu beside the list
 * it sorts. The page checks members.view; members.manage unlocks
 * create/rename/delete and managing membership.
 */
...
export function GroupsSection({ teamId }: { teamId: string }) {
