...
import { commitAttendanceImportHandler, previewAttendanceImportHandler } from "./procedures/attendance-import.js";
import {
...
export const router = os.router({
  ...
  commitAttendanceImport: commitAttendanceImportHandler,
